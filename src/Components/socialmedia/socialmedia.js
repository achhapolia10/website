    ...
    render = () => {
        return (
            <div id={"social-media"} className={"social-media"} style={{textOrientation: "right"}}>
                ...
                <div className={"sicon"}>
                    {/* Github */}
                    <a href="https://github.com/achhapolia10" target="_blank" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="438.549" height="438.549"
                             viewBox="0 0 438.549 438.549" role="img"
                             aria-labelledby="aa25mdvacxzwofky07ipo51qnhhy85wd" className="icon-img"><title
                            id="aa25mdvacxzwofky07ipo51qnhhy85wd">GitHub</title>
                            <path
                ...
                <div className={"sicon"}>
                    {/* Facebook */}
                    <a href="https://www.facebook.com/achhapolia10" target="_blank" rel="noopener me">

                        {/*<!-- Generator: Adobe Illustrator 16.0.0, SVG Export Plug-In . SVG Version: 6.00 Build 0)  -->*/}
                        <svg xmlns="http://www.w3.org/2000/svg"
                             version="1.1" id="Capa_1" x="0px" y="0px" width="90px" height="90px"
                             viewBox="0 0 90 90"

                             role="img" aria-labelledby="alcghljij09fu6dru4f4jos27sok835d"
                             className="icon-img"><title id="alcghljij09fu6dru4f4jos27sok835d">Facebook
                        </title>
                            <g>
                ...
                <div className={"sicon"}>
                    {/*twitter*/}
                    <a href="https://twitter.com/silent_c0der" target="_blank" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 612 612" role="img"
                             aria-labelledby="ag29ehpcvgadqngx2q3dtigko9aydk2e"
                             className="icon-img"><title

                            id="ag29ehpcvgadqngx2q3dtigko9aydk2e">Twitter</title>
                            <path
                ...
                <div className={"sicon"}>
                    {/* Gitlab */}
                    <a href="https://gitlab.com/achhapolia10" target="_blank" rel="noopener nofollow me">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img"
                             aria-labelledby="a8uaksffun50as50hhlr4h5owom7bt6a" className="icon-img"><title
                            id="a8uaksffun50as50hhlr4h5owom7bt6a">GitLab</title>
                            <path
                ...
                <div className={"sicon"}>
                    {/* dev.to */}
                    <a href="https://dev.to/achhapolia10">
                        <svg role="img" xmlns="http://www.w3.org/2000/svg"
                             className={"icon-img"} viewBox="0 0 448 512">
