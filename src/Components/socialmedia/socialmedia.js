...
class SocialMedia extends React.Component {
    render = () => {
        return (
            <div id={"social-media"} style={{textOrientation: "right"}}>
                <div className={"sicon"}>
                    {/*linkedin*/}
                    <a href="https://www.linkedin.com/in/achhapolia10/" target="_blank" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg"
                             ...
                             className="icon-img"><title id="a3p01ardx5dijtnzqiyynimz3psgvwoh">LinkedIn logo</title>
                            <path className="st0"
                ...
                <div className={"sicon"}>
                    ...
                    <a href="https://github.com/achhapolia10" target="_blank" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" width="438.549" height="438.549"
                            ...
                            id="aa25mdvacxzwofky07ipo51qnhhy85wd">GitHub logo</title>
                            <path
                ...
                <div className={"sicon"}>
                    ...
                    <a href="https://twitter.com/silent_c0der" target="_blank" rel="noopener me">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 612 612" role="img"
                            ...
                            id="ag29ehpcvgadqngx2q3dtigko9aydk2e">Twitter logo</title>
                            <path
                ...
                <div className={"sicon"}>
                    ...
                    <a href="https://gitlab.com/achhapolia10" target="_blank" rel="noopener nofollow me">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" role="img"
                            ...
                            id="a8uaksffun50as50hhlr4h5owom7bt6a">GitLab logo</title>
                            <path
